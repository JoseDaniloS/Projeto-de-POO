...
public class Membro extends Usuario {
    ...
    private Membro(String nome, String cpf, String login, String senha, String endereco, String telefone,
            String email) {
    ...
    public static Membro criarMembro(String nome, String cpf, String login, String senha, String endereco,
    ...
    public static void editarMembro(Membro membro, String nome, String cpf, String login, String senha, boolean ativo,
